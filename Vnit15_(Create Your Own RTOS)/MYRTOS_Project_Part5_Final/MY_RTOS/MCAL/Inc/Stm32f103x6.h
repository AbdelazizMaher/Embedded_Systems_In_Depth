...
#define NVIC_ISER0									 *( volatile uint32_t * )( NVIC_BASEADDR + 0x00 )
#define NVIC_ISER1									 *( volatile uint32_t * )( NVIC_BASEADDR + 0x04 )
#define NVIC_ISER2									 *( volatile uint32_t * )( NVIC_BASEADDR + 0x08 )

#define NVIC_ICER0									 *( volatile uint32_t * )( NVIC_BASEADDR + 0x80 )
#define NVIC_ICER1									 *( volatile uint32_t * )( NVIC_BASEADDR + 0x84 )
#define NVIC_ICER2									 *( volatile uint32_t * )( NVIC_BASEADDR + 0x88 )
...
//SPI
#define RCC_SPI1_RESET()						( RCC->APB1RSTR |= ( 1 << 12 ) )
...
#define NVIC_IRQ36_SPI2_ENABLE()                ( NVIC_ISER1 |= 1 << (SPI1_IRQ - 32) )
...
#define NVIC_IRQ36_SPI2_DISABLE()               ( NVIC_ICER1 |= 1 << (SPI1_IRQ - 32) )
...
#define I2C_OAR1_ADDMODE                    I2C_OAR1_ADDMODE_Msk               /*!< Addressing Mode  */
