...
int Test_getPressureVal()
{
	...
	case 2:
		printf("\n======================================== \n");
		printf("Test Case 2: Input = 22 -> Output: ALarm \n");
		printf("Test Case 2: Running \n");
			
		Test_PressureSensorReading = 22;
...
void Test_SetAlarmActuator(int i)
{
	...
	else if( Test_CaseNumber == 3 )
	{
		printf("============================================================= \n");
		printf("==========TestCases Completed : Terminate The Execution====== \n");
		printf("============================================================= \n");
		exit(1);
	}		
}
